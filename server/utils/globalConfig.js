...
/*    //Mysql Config
    ...
    */
    ...
    config.slave2Ip = 'worlddesk-r1-slave1.cgbemsumnr3x.ap-south-1.rds.amazonaws.com';
    ...
    //Kafka Configuration
    config.BROKER_HOST = "127.0.0.1:9092";
    ...
    config.TOPIC_NAME = "activities10";
    config.WIDGET_TOPIC_NAME="form-widgets10";
...
if (mode === 'dev') {
    ...
    //Kafka Configuration
    config.BROKER_HOST = "192.168.1.39:9092,192.168.3.39:9092,192.168.0.39:9092";
    config.BROKER_CONNECT_TIMEOUT = 10000;
    config.BROKER_REQUEST_TIMEOUT = 60000;
    config.BROKER_AUTO_CONNECT = true;
    config.BROKER_MAX_ASYNC_REQUESTS = 10;
