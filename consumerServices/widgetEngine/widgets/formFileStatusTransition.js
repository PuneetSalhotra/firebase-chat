    	...
    	if(data.req_activity_status_id == this.rule.widget_entity3_id){
            ...
            this.services.activityStatusChangeTxnService.activityStatusChangeTxnActivityStatus(activityQueryData).then((min_result)=>{
            	...
            	this.services.activityStatusChangeTxnService.activityStatusChangeTxnActivityStatus(activityQueryData).then((max_result)=>{  
            		...
            		global.logger.write('debug', 'Transition: WidgetId'+this.rule.widget_id+' MAX DATETIME: '+max_datetime, {}, data);
            		global.logger.write('debug', 'Transition: WidgetId'+this.rule.widget_id+' MIN DATETIME: '+min_datetime, {}, data);
                	...
                	this.services.activityStatusChangeTxnService.activityStatusChangeTxnInsert(activityQueryData, aggregate).then(()=>{
                		global.logger.write('debug', 'Transition: WidgetId '+this.rule.widget_id+' WAIT FOR 2 SECS START: '+this.objCollection.util.getCurrentUTCTime(), {}, data);
                		this.services.activityListService.wait(2000).then(()=>{  
	                		...
	                		this.services.activityStatusChangeTxnService.activityStatusChangeTxnIntermediateAggr(activityQueryData).then((result)=>{
	                			global.logger.write('debug', 'Transition: WidgetId '+this.rule.widget_id+' WAIT FOR 2 SECS END: '+this.objCollection.util.getCurrentUTCTime(), {}, data);
	    	 	               ...
	    	 	               global.logger.write('debug', 'Transition: WidgetId : '+this.rule.widget_id+' AGGR TO WIDGET : '+result[0].duration, {}, data);
    		...
    		global.logger.write('debug', 'Transition: WidgetId : '+this.rule.widget_id+' : '+data.req_activity_status_id+' NOT EQUALS TO RULE STATUS '+this.rule.widget_entity3_id, {}, data);
    	}
    }
